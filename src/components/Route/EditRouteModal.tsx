...
const EditRouteModal: React.FC<{ open: boolean; onClose: () => void,editData:any,onSave: (newRoute: { name: string; shortname: string; active: boolean }) => void}> = ({
  open,
  onClose,
  editData,
  onSave
    ...
    <div className="fixed inset-0  bg-opacity-50 flex justify-center items-center z-50 animate-jump-in bg-slate-50">
      <div className="bg-white p-6 rounded-2xl w-[30rem] border-2 border-gray-200 shadow-2xl">
        ...
        <div className="flex justify-between items-center">
          <h1 className="text-xl font-semibold">Route Master</h1>
          <button
            onClick={onClose}
