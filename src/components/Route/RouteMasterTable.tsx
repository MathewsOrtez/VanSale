...
const handleDeleteSelected = () => {
  ...
  return (
    ...
    <div className="mx-4">
      <div className="flex justify-between items-center my-7">
          ...
          />
            ...
            <div className="flex gap-4 ">
              ...
              {/* Add New Button */}
              <button className="  w-[98px] h-[33px] bg-[#25add7] rounded-md text-white  font-medium hover:bg-[#1a8d9d] transition-colors"
      ...
      <table className={`w-full   border-collapse rounded-md ${openModal ? "blur-sm" : ""} ${editModal ? "blur-sm" : ""}  ${openNewModal ? "blur-sm" : ""}`}>
        <thead className="bg-gray-100 border text-sm">
          <tr>
          <th className=" text-gray-500 font-semibold text-start py-1"><CustomizedCheckbox checked={selectAll}
                onChange={(e) => handleHeaderCheckboxChange(e.target.checked)}/></th>
          <th className=" text-gray-500 font-semibold text-start py-1" >Srl</th>
          <th className=" text-gray-500 font-semibold text-start py-1" >Name</th>
          <th className=" text-gray-500 font-semibold text-start py-1" >Short Name</th>
          <th className=" text-gray-500 font-semibold text-center py-1" >Active</th>
          <th className=" text-gray-500 font-semibold text-center py-1" >Edit</th>
          <th className=" text-gray-500 font-semibold text-center py-1" >Delete</th>
          </tr>
        </thead>
   ...
   <div>
      ...
      {openNewModal && <NewRouteModal open={openNewModal} onClose={handleNewClose} onSave={handleSave} />}
      {openModal && <DeleteRouteModal open={openModal} onClose={handleClose} deleteData={deleteData} onSave={handleSave} onDelete={handleDelete} />}
      {editModal && (
        <EditRouteModal open={editModal} onClose={handleEditClose} editData={editData} onSave={handleSave} />
      )}
